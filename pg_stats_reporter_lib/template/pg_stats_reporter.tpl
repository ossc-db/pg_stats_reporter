...
<script type="text/javascript" src="{$jqplot_path}plugins/jqplot.categoryAxisRenderer.js"></script>
<script type="text/javascript" src="{$jqplot_path}plugins/jqplot.canvasTextRenderer.js"></script>
<script type="text/javascript" src="{$jqplot_path}plugins/jqplot.canvasAxisTickRenderer.js"></script>
<script type="text/javascript" src="{$jqplot_path}plugins/jqplot.pointLabels.js"></script>
<script type="text/javascript" src="{$dygraphs_path}dygraph.min.js"></script>
...
<link rel="stylesheet" type="text/css" href="{$jqplot_path}jquery.jqplot.min.css"/>
<link rel="stylesheet" type="text/css" href="{$tablesorter_path}css/theme.blue.css"/>
<link rel="stylesheet" type="text/css" href="{$dygraphs_path}dygraph.css"/>
